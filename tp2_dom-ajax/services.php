...
Services list:
	http://.../services.php?action=list - on obtient la liste des données
	http://.../services.php?action=add&x=42&message=hop - ajoute un objet avec les paramètres qu'on veut
